...
class confirmButton extends Widget{
    ...
    public function run(){
        ...
        $cancel=Html::tag('a',Yii::t('backend','BUTTON_CANCEL'),['class'=>'btn-cancel btn btn-cancel-mini','rel'=>'close','href'=>'#']);

        $ok=Html::tag('a',Yii::t('backend','BUTTON_OK'),['class'=>'btn-ok btn btn-ok-mini','href'=>$this->url, 'id'=>'btn-ok-'.$this->id ]);
